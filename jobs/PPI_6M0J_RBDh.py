...
def feat_job(list_, folder1, folder2):
    ...
    for ilist in list_:
        ...
        fp.write(f'cd /mnt/research/guowei-search.4/junjie-ppi/6M0J_RBDh/{dst}\n')
...
def gen_PDBs(PDBid, Antibody, Antigen, Chain, resWT, resID, resMT, pH):
    ...
    #os.system("ln -s 6M0J_RBDh/{}.pdb {}{}.pdb".format(PDBid, curr_dir, PDBid))
...
if not os.path.exists("./6M0J_RBDh/features/"):
    os.system("mkdir ./6M0J_RBDh/features/")

seq_list = dataset_list("./6M0J_RBDh/6M0J_RBDh.txt")
#print(seq_list)
#mp_gen_PDBs(seq_list)

if not os.path.exists("./6M0J_RBDh/blast_jobs/"):
    os.mkdir("./6M0J_RBDh/blast_jobs/")
if not os.path.exists("./6M0J_RBDh/blast_out/"):
    os.mkdir("./6M0J_RBDh/blast_out/")
...
if not os.path.exists("./6M0J_RBDh/feat_jobs/"):
    os.mkdir("./6M0J_RBDh/feat_jobs/")

if not os.path.exists("./6M0J_RBDh/feat_out/"):
    os.mkdir("./6M0J_RBDh/feat_out/")

feat_job(seq_list, "features", "feat_jobs")
#run_feat(seq_list, "features", "feat_jobs")

if not os.path.exists("./6M0J_RBDh/seq_jobs/"):
    os.mkdir("./6M0J_RBDh/seq_jobs/")

if not os.path.exists("./6M0J_RBDh/seq_out/"):
    os.mkdir("./6M0J_RBDh/seq_out/")
