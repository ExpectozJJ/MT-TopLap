...
def feat_job(list_, folder1, folder2):
    ...
    for ilist in list_:
        ...
        fp.write(f'cd /mnt/research/guowei-search.4/junjie-ppi/7KL9_CTCa/{dst}\n')
...
def gen_PDBs(PDBid, Antibody, Antigen, Chain, resWT, resID, resMT, pH):
    ...
    #os.system("ln -s 7KL9_CTCa/{}.pdb {}{}.pdb".format(PDBid, curr_dir, PDBid))
...
if not os.path.exists("./7KL9_CTCa/features/"):
    os.system("mkdir ./7KL9_CTCa/features/")

seq_list = dataset_list("./7KL9_CTCa/7KL9_CTCa.txt")
#print(seq_list)
#mp_gen_PDBs(seq_list)

if not os.path.exists("./7KL9_CTCa/blast_jobs/"):
    os.mkdir("./7KL9_CTCa/blast_jobs/")
if not os.path.exists("./7KL9_CTCa/blast_out/"):
    os.mkdir("./7KL9_CTCa/blast_out/")
...
if not os.path.exists("./7KL9_CTCa/feat_jobs/"):
    os.mkdir("./7KL9_CTCa/feat_jobs/")

if not os.path.exists("./7KL9_CTCa/feat_out/"):
    os.mkdir("./7KL9_CTCa/feat_out/")

feat_job(seq_list, "features", "feat_jobs")
#run_feat(seq_list, "features", "feat_jobs")

if not os.path.exists("./7KL9_CTCa/seq_jobs/"):
    os.mkdir("./7KL9_CTCa/seq_jobs/")

if not os.path.exists("./7KL9_CTCa/seq_out/"):
    os.mkdir("./7KL9_CTCa/seq_out/")
