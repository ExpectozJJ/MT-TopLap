...
def feat_job(list_, folder1, folder2):
    ...
    for ilist in list_:
        ...
        fp.write(f'cd /mnt/research/guowei-search.4/junjie-ppi/7T9L_RBD/{dst}\n')
...
def gen_PDBs(PDBid, Antibody, Antigen, Chain, resWT, resID, resMT, pH):
    ...
    #os.system("ln -s 7T9L_RBD/{}.pdb {}{}.pdb".format(PDBid, curr_dir, PDBid))
...
if not os.path.exists("./7T9L_RBD/features/"):
    os.system("mkdir ./7T9L_RBD/features/")

seq_list = dataset_list("./7T9L_RBD/7T9L_RBD.txt")
#print(seq_list)
#mp_gen_PDBs(seq_list)

if not os.path.exists("./7T9L_RBD/blast_jobs/"):
    os.mkdir("./7T9L_RBD/blast_jobs/")
if not os.path.exists("./7T9L_RBD/blast_out/"):
    os.mkdir("./7T9L_RBD/blast_out/")
...
if not os.path.exists("./7T9L_RBD/feat_jobs/"):
    os.mkdir("./7T9L_RBD/feat_jobs/")

if not os.path.exists("./7T9L_RBD/feat_out/"):
    os.mkdir("./7T9L_RBD/feat_out/")

feat_job(seq_list, "features", "feat_jobs")
#run_feat(seq_list, "features", "feat_jobs")

if not os.path.exists("./7T9L_RBD/seq_jobs/"):
    os.mkdir("./7T9L_RBD/seq_jobs/")

if not os.path.exists("./7T9L_RBD/seq_out/"):
    os.mkdir("./7T9L_RBD/seq_out/")
