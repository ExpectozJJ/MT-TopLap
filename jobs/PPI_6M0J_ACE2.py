...
def feat_job(list_, folder1, folder2):
    ...
    for ilist in list_:
        ...
        fp.write(f'cd /mnt/research/guowei-search.4/junjie-ppi/6M0J_ACE2/{dst}\n')
...
def gen_PDBs(PDBid, Antibody, Antigen, Chain, resWT, resID, resMT, pH):
    ...
    #os.system("ln -s 6M0J_ACE2/{}.pdb {}{}.pdb".format(PDBid, curr_dir, PDBid))
...
if not os.path.exists("./6M0J_ACE2/features/"):
    os.system("mkdir ./6M0J_ACE2/features/")

seq_list = dataset_list("./6M0J_ACE2/6M0J_ACE2.txt")
#print(seq_list)
#mp_gen_PDBs(seq_list)

if not os.path.exists("./6M0J_ACE2/blast_jobs/"):
    os.mkdir("./6M0J_ACE2/blast_jobs/")
if not os.path.exists("./6M0J_ACE2/blast_out/"):
    os.mkdir("./6M0J_ACE2/blast_out/")
...
if not os.path.exists("./6M0J_ACE2/feat_jobs/"):
    os.mkdir("./6M0J_ACE2/feat_jobs/")

if not os.path.exists("./6M0J_ACE2/feat_out/"):
    os.mkdir("./6M0J_ACE2/feat_out/")

feat_job(seq_list, "features", "feat_jobs")
#run_feat(seq_list, "features", "feat_jobs")

if not os.path.exists("./6M0J_ACE2/seq_jobs/"):
    os.mkdir("./6M0J_ACE2/seq_jobs/")

if not os.path.exists("./6M0J_ACE2/seq_out/"):
    os.mkdir("./6M0J_ACE2/seq_out/")
